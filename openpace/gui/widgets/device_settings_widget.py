...
class DeviceSettingsWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.operator_section = self._create_section(
            "OPERATOR-DEFINED SETTINGS", "#1565C0"
        )
    ...
    def _populate_fixed_settings(self):
        ...
        if self.transmission:
            ...
            if self.transmission.device_model:
                self._add_row(
                    self.device_group, "Model", self.transmission.device_model
                )
            if self.transmission.device_serial:
                self._add_row(
                    self.device_group, "Serial Number", self.transmission.device_serial
                )
    ...
    def _populate_operator_settings(self):
        ...
        brady_vars = [
            ...
            "set_brady_sav_delay_high",
            "set_brady_sav_delay_low",
            "set_brady_pav_delay_high",
            "set_brady_pav_delay_low",
            "set_brady_sensor_type",
            "set_brady_at_mode_switch_mode",
            "set_brady_at_mode_switch_rate",
        ]
        ...
        for zone_id in sorted(self.zone_settings.keys()):
            ...
            header_label.setStyleSheet(
                "font-weight: bold; color: #1565C0; margin-top: 5px;"
            )
            ...
            zone_vars = [
                "set_zone_status",
                "set_zone_detection_interval",
                "set_zone_atp_type_1",
                "set_zone_num_atp_seqs_1",
                "set_zone_atp_type_2",
                "set_zone_num_atp_seqs_2",
                "set_zone_shock_energy_1",
                "set_zone_num_shocks_1",
                "set_zone_shock_energy_2",
                "set_zone_num_shocks_2",
                "set_zone_shock_energy_3",
                "set_zone_num_shocks_3",
            ]
        ...
        # Sensing settings
        sensing_vars = [
            "set_leadchnl_ra_sensing_sensitivity",
            "set_leadchnl_rv_sensing_sensitivity",
            "set_leadchnl_ra_sensing_polarity",
            "set_leadchnl_rv_sensing_polarity",
            "set_leadchnl_ra_sensing_adaptation",
            "set_leadchnl_rv_sensing_adaptation",
        ]
        ...
        # Pacing settings
        pacing_vars = [
            "set_leadchnl_ra_pacing_amplitude",
            "set_leadchnl_rv_pacing_amplitude",
            "set_leadchnl_ra_pacing_pulsewidth",
            "set_leadchnl_rv_pacing_pulsewidth",
            "set_leadchnl_ra_pacing_polarity",
            "set_leadchnl_rv_pacing_polarity",
            "set_leadchnl_ra_pacing_capture_mode",
            "set_leadchnl_rv_pacing_capture_mode",
        ]
    ...
    def _populate_measurements(self):
        ...
        battery_vars = [
            "msmt_battery_status",
            "msmt_battery_remaining_longevity",
            "msmt_battery_remaining_percentage",
            "msmt_cap_charge_time",
        ]
        ...
        # Lead measurements
        lead_msmt_vars = [
            "msmt_leadchnl_ra_impedance",
            "msmt_leadchnl_rv_impedance",
            "msmt_leadchnl_ra_sensing_amplitude",
            "msmt_leadchnl_rv_sensing_amplitude",
        ...
        # Statistics
        stat_vars = [
            "stat_brady_ra_percent_paced",
            "stat_brady_rv_percent_paced",
            "stat_at_burden_percent",
            "stat_tachy_shocks_delivered_total",
    ...
    def _hide_empty_groups(self):
        ...
        measurement_visible = any(
            g.row_count > 0
            for g in [self.battery_group, self.lead_msmt_group, self.stats_group]
        )
